<template>
  <div class="home-container">
    ...
    <nav class="navbar" :style="s.navbar">
      <div class="nav-brand" :style="s.navBrand">NEON-SYX</div>
      <div class="nav-links" :style="s.navLinks">
        <a href="https://github.com/finegoodok/neon-syx" target="_blank" class="github-link" :style="s.githubLink">
      ...
      <section class="hero-section" :style="s.heroSection">
        ...
        <div class="hero-right" :style="s.heroRight">
          <div class="logo-container" :style="s.logoContainer">
            <img src="../assets/logo/MiroFish_logo_left.jpeg" alt="NeonSyx Logo" :style="s.heroLogo" />
          </div>
